# This code was taken from github (Apache License 2.0)

# It is an implementation of the word mover embedding (sentence embedding):
# Wu, Lingfei, Ian En-Hsu Yen, Kun Xu, Fangli Xu, Avinash Balakrishnan, Pin-Yu Chen,
# Pradeep Ravikumar, and Michael J. Witbrock. 2018. “Word Mover’s Embedding:
# From Word2Vec to Document Embedding.” In Proceedings of the 2018 Conference on
# Empirical Methods in Natural Language Processing, 4524–34.

# - Xiaohang Zhao (empenguinxh)
# - Taken 06-11-21
# - Word Mover embedding
# - Source code
# - https://github.com/empenguinxh/PyWME
...
def compute_wme(corpus_fp, R, D_min, D_max, gamma, nuw_max, wv_name, exp_id, no_cache):
    ...
    with open(corpus_fp, 'r', encoding = "ISO-8859-1") as f:
